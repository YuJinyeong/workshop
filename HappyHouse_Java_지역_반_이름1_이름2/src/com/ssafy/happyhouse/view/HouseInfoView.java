...
//		} else {
//			icon = new ImageIcon("img/"+hi.getImg()+".jpg");
//		}
//
//		imgL.setIcon(icon);
		...
		try {
			...
			try {
				String a = curHouse.getAptName();
				img = ImageIO.read(new File("img/"+hi.getImg()+".jpg"));
...
//      });
	...
	public void setMain() {
		...
		JButton btn = new JButton("주변 환경 오염 정보 분석");
		...
		// 데이터를 충분히 확보할 시간이 부족해서 일단 모든 리스트를 보이게 했습니다!
