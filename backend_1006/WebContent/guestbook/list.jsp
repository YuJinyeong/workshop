	...
	<div class="container" align="center">
		<div class="col-lg-8" align="right">
			<strong>${userinfo.username}</strong>님 환영합니다. <a
				href="${root}/main.do?act=logout">로그아웃</a>
		</div>
				...
				<c:forEach var="article" items="${articles }">
					<table class="table table-active">
						<tbody>
							...
							<tr>
								<td colspan="2" class="table-danger"><strong>${article.articleleno }.${article.subject }</strong></td>
							</tr>
							<tr>
							...
							<c:if test="${article.userid eq userinfo.userid }">
								<tr>
									<td colspan="2"><a
										href="${root}/main.do?act=mvmodify&articleno=${article.articleno}">수정</a>
										<a
										href="${root}/main.do?act=delete&articleno=${article.articleno}">삭제</a>
									</td>
								</tr>
							</c:if>
						</tbody>
