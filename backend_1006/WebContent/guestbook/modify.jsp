...
<div class="container" align="center">
	...
	<div class="col-lg-6" align="center">
		...
		<input type="hidden" name="articleno" id="articleno" value="<%= guestBookDto.getArticleno() %>">
			<div class="form-group" align="left">
				<label for="subject">제목:</label>
				<input type="text" class="form-control" id="subject" name="subject" value="<%= guestBookDto.getSubject() %>">
			</div>
			<div class="form-group" align="left">
				<label for="content">내용:</label>
				<textarea class="form-control" rows="15" id="content" name="content"><%= guestBookDto.getContent() %></textarea>
			</div>
